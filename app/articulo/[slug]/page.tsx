          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
                    ...
                    <div key={index}>
                      ...
                      {index === 2 && (
                        <div className="my-8">
                          ...
                          />
                          <p className="text-sm text-gray-500 mt-2 text-center">Imagen ilustrativa del mercado inmobiliario actual</p>
                        </div>
                      )}
              ...
              <div className="flex flex-wrap justify-center gap-4 my-8">
                ...
                <Button
                  onClick={() => window.open(`https://api.whatsapp.com/send?text=${encodeURIComponent(`¡Mira este artículo interesante! ${shareUrl}`)}`, '_blank')}
              ...
              >
                {article.category === 'analisis-de-mercado' ? 'Ver Análisis Interactivo' : 'Explora el mercado inmobiliario'}
              </Button>
                ...
                <div className="mt-12">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {suggestedArticles.map((suggestedArticle) => (
                      <Card key={suggestedArticle.id} className="overflow-hidden hover:shadow-lg transition-shadow duration-300">
                        <Image
